	...
	switch (option)
	{
		case 1:
			for (i = 0; i < image->W; i++)
			{
				for (j = 0; j < image->H; j++)
				{
					SetPixelR(image, (image->W - 1 - i), j, GetPixelR(image, i, j));
					SetPixelG(image, (image->W - 1 - i), j, GetPixelG(image, i, j));
					SetPixelB(image, (image->W - 1 - i), j, GetPixelB(image, i, j));
		...
		case 2:
			for (i = 0; i < image->W; i++)
			{
				for (j = 0; j < image->H; j++)
				{
					SetPixelR(image, i, (image->H - 1 - j), GetPixelR(image, i, j));
					SetPixelG(image, i, (image->H - 1 - j), GetPixelG(image, i, j));
					SetPixelB(image, i, (image->H - 1 - j), GetPixelB(image, i, j));
